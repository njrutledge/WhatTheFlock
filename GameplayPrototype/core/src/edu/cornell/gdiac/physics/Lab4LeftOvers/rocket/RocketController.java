...
//	private SoundBuffer burnSound;
//	/** The sound for the left afterburner */
//	private SoundBuffer leftSound;
//	/** The sound for the right afterburner */
//	private SoundBuffer rghtSound;
...
//
//		bumpSound  = directory.getEntry( "rocket:bump", SoundBuffer.class );
//		burnSound  = directory.getEntry( "rocket:mainburn", SoundBuffer.class );
//		leftSound  = directory.getEntry( "rocket:leftburn", SoundBuffer.class );
//		rghtSound = directory.getEntry( "rocket:rightburn", SoundBuffer.class );
...
//	    SoundBuffer sound = rocket.getBurnerSound(burner);
