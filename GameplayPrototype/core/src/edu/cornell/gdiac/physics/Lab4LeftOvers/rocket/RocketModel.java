...
public class RocketModel extends BoxObstacle {
	...
	public void applyForce() {
		...
		Vector2 force = new Vector2(this.getFX(),this.getFY());
	 ...
	 */
	public SoundBuffer getBurnerSound(Burner burner) {
	    switch (burner) {
	        case MAIN:
	            return mainSound;
	        case LEFT:
	 ...
	 */
	public void setBurnerSound(Burner burner, SoundBuffer sound) {
	    switch (burner) {
	        case MAIN:
	            mainSound = sound;
	            break;
