...
public class RagdollController extends WorldController {
	...
	/** The bubble sounds */
	private SoundBuffer[] bubbleSounds;
	...
	public void gatherAssets(AssetDirectory directory) {
		...
		bubbleSounds = new SoundBuffer[constants.get("bubbles").getInt("sounds",0)];
		for(int ii = 0; ii < bubbleSounds.length; ii++) {
			bubbleSounds[ii] = directory.getEntry( "ragdoll:glub"+(ii+1), SoundBuffer.class );
		}
