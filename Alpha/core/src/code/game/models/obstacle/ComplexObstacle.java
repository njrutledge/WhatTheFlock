 ...
 * hierarchy. All of the game methods in the class apply to the root, not the body.
...
public abstract class ComplexObstacle extends Obstacle {
    ...
    protected Body body;
	/** A complex game object has multiple bodies */
	...
	/**
	 * Creates a new complex game object at the origin.
	 */
	...
	/**
	 * Creates a new complex game object
	 * 
	 ...
	 * override for custom game objects.
	 *
