 ...
 *
 * This class implements a selection tool for dragging game objects with a mouse.
...
/**
 * Selection tool to move and drag game obstacles
 *
...
public class ObstacleSelector implements QueryCallback  {
    ...
    /**
     * Returns true if a game body is currently selected
     *
     * @return true if a game body is currently selected
     */
     ...
     *
     * Just because a game body was selected does not mean that an Obstacle was
    ...
    /**
     * Returns true if a game body was selected at the given position.
     *
     ...
     *
     * @param  x  the x-coordinate (in game space) to select
     * @param  y  the y-coordinate (in game space) to select
     *
     * @return true if a game body was selected at the given position.
     */
     ...
     *
     * @param  x  the x-coordinate (in game space) to move to
     * @param  y  the y-coordinate (in game space) to move to
     *
    ...
    /**
     * Deselects the game body, discontinuing any mouse movement.
     *
