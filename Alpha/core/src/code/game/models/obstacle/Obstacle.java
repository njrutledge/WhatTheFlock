 ...
 * There should be NO game controlling logic code in a game objects,
...
public abstract class Obstacle {
	...
	/// BodyDef Methods
	/**
	 * Returns the body type for Box2D game
	 *
	 ...
	 * external forces (e.g. gravity). DYNAMIC makes this is a full-blown game object.
	 *
	 * @return the body type for Box2D game
	 */
	...
	/**
	 * Returns the current position for this game body
	 *
	 ...
	 *
	 * @return the current position for this game body
	 */
	...
	/**
	 * Sets the current position for this game body
	 *
	 * This method does not keep a reference to the parameter.
	 *
	 * @param value  the current position for this game body
	 */
	 ...
	 * Sets the current position for this game body
	 *
	 * @param x  the x-coordinate for this game body
	 * @param y  the y-coordinate for this game body
	 */
	...
	/**
	 * Returns the x-coordinate for this game body
	 *
	 * @return the x-coordinate for this game body
	 */
	public float getX() {
	...
	/**
	 * Sets the x-coordinate for this game body
	 *
	 * @param value  the x-coordinate for this game body
	 */
	...
	/**
	 * Returns the y-coordinate for this game body
	 *
	 * @return the y-coordinate for this game body
	 */
	public float getY() {
	...
	/**
	 * Sets the y-coordinate for this game body
	 *
	 * @param value  the y-coordinate for this game body
	 */
	...
	/**
	 * Returns the linear velocity for this game body
	 *
	 * This method does NOT return a reference to the velocity vector. Changes to this 
	 * vector will not affect the body.  However, it returns the same vector each time
	 * its is called, and so cannot be used as an allocator.
	 *
	 * @return the linear velocity for this game body
	 */
	...
	/**
	 * Sets the linear velocity for this game body
	 *
	 * This method does not keep a reference to the parameter.
	 *
	 * @param value  the linear velocity for this game body
	 */
	...
	/**
	 * Returns the x-velocity for this game body
	 *
	 * @return the x-velocity for this game body
	 */
	public float getVX() {
	...
	/**
	 * Sets the x-velocity for this game body
	 *
	 * @param value  the x-velocity for this game body
	 */
	...
	/**
	 * Returns the y-velocity for this game body
	 *
	 * @return the y-velocity for this game body
	 */
	public float getVY() {
	...
	/**
	 * Sets the y-velocity for this game body
	 *
	 * @param value  the y-velocity for this game body
	 */
	...
	/**
	 * Returns the angular velocity for this game body
	 *
	 * The rate of change is measured in radians per step
	 *
	 * @return the angular velocity for this game body
	 */
	...
	/**
	 * Sets the angular velocity for this game body
	 *
	 * @param value the angular velocity for this game body (in radians)
	 */
	 ...
	 *
	 * An sleeping body is one that has come to rest and the game engine has decided
	 ...
	 * its is called, and so cannot be used as an allocator.
	 *
	 * @return the center of mass for this game body
	 */
	...
	/**
	 * Sets the center of mass for this game body
	 *
	 * This method does not keep a reference to the parameter.
	 *
	 * @param value  the center of mass for this game body
	 */
	 ...
	 *
	 * A garbage collected object will be removed from the game world at
	 * the next time step.
	 *
	...
	/// DRAWING METHODS
	/**
     * Returns the drawing scale for this game object
     *
     * The drawing scale is the number of pixels to draw before Box2D unit. Because
     * mass is a function of area in Box2D, we typically want the game objects
     ...
     * We allow for the scaling factor to be non-uniform.
     *
     * @param value  the drawing scale for this game object
     */
	...
	/**
	 * Create a new game object at the origin.
	 */
	protected Obstacle() { 
		this(0,0);
	}
	...
	protected Obstacle(float x, float y) {
		...
		// Objects are game objects unless otherwise noted
	...
	/**
	 * Destroys the game Body(s) of this object if applicable,
