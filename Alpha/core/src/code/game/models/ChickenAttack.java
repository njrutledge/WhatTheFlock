        ...
        switch (type) {
            ...
            case Projectile:
                if (!breaking) {
                    ...
                    canvas.draw(eggSpin, Color.WHITE, originSpin.x, originSpin.y, getX() * drawScale.x, getY() * drawScale.y, getAngle(), displayScale.x*0.25f, displayScale.y*0.25f);
                }
                else{
                    eggSplat.setFrame((int) animeframe);
                    canvas.draw(eggSplat, Color.WHITE, originSplat.x, originSplat.y, getX() * drawScale.x, getY() * drawScale.y, getAngle(), displayScale.x*0.15f, displayScale.y*0.15f);
                }
                break;
            case Explosion:
